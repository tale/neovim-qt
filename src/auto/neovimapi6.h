...
class NeovimApi6 : public QObject {
  ...
  public slots:
    ...
    // Boolean nvim_buf_attach(Buffer buffer, Boolean send_buffer, Dictionary
    // opts, )
    NeovimQt::MsgpackRequest *nvim_buf_attach(int64_t buffer, bool send_buffer,
                                              QVariantMap opts);
    ...
    NeovimQt::MsgpackRequest *buffer_set_line(int64_t buffer, int64_t index,
                                              QByteArray line);
    // DEPRECATED
    // void buffer_del_line(Buffer buffer, Integer index, )
    NeovimQt::MsgpackRequest *buffer_del_line(int64_t buffer, int64_t index);
    // DEPRECATED
    // ArrayOf(String) buffer_get_line_slice(Buffer buffer, Integer start,
    // Integer end, Boolean include_start, Boolean include_end, )
    NeovimQt::MsgpackRequest *buffer_get_line_slice(int64_t buffer,
                                                    int64_t start, int64_t end,
                                                    bool include_start,
                                                    bool include_end);
    // ArrayOf(String) nvim_buf_get_lines(Buffer buffer, Integer start, Integer
    // end, Boolean strict_indexing, )
    NeovimQt::MsgpackRequest *nvim_buf_get_lines(int64_t buffer, int64_t start,
                                                 int64_t end,
                                                 bool strict_indexing);
    // DEPRECATED
    // void buffer_set_line_slice(Buffer buffer, Integer start, Integer end,
    // Boolean include_start, Boolean include_end, ArrayOf(String) replacement,
    // )
    NeovimQt::MsgpackRequest *
    buffer_set_line_slice(int64_t buffer, int64_t start, int64_t end,
    ...
    // Boolean strict_indexing, ArrayOf(String) replacement, )
    NeovimQt::MsgpackRequest *nvim_buf_set_lines(int64_t buffer, int64_t start,
                                                 int64_t end,
                                                 bool strict_indexing,
                                                 QList<QByteArray> replacement);
    // Integer nvim_buf_get_offset(Buffer buffer, Integer index, )
    NeovimQt::MsgpackRequest *nvim_buf_get_offset(int64_t buffer,
                                                  int64_t index);
    ...
    NeovimQt::MsgpackRequest *nvim_buf_get_keymap(int64_t buffer,
                                                  QByteArray mode);
    // void nvim_buf_set_keymap(Buffer buffer, String mode, String lhs, String
    // rhs, Dictionary opts, )
    NeovimQt::MsgpackRequest *
    nvim_buf_set_keymap(int64_t buffer, QByteArray mode, QByteArray lhs,
                        QByteArray rhs, QVariantMap opts);
    // void nvim_buf_del_keymap(Buffer buffer, String mode, String lhs, )
    NeovimQt::MsgpackRequest *
    nvim_buf_del_keymap(int64_t buffer, QByteArray mode, QByteArray lhs);
    // Dictionary nvim_buf_get_commands(Buffer buffer, Dictionary opts, )
    NeovimQt::MsgpackRequest *nvim_buf_get_commands(int64_t buffer,
                                                    QVariantMap opts);
    // void nvim_buf_set_var(Buffer buffer, String name, Object value, )
    NeovimQt::MsgpackRequest *nvim_buf_set_var(int64_t buffer, QByteArray name,
                                               QVariant value);
    ...
    NeovimQt::MsgpackRequest *buffer_set_var(int64_t buffer, QByteArray name,
                                             QVariant value);
    // DEPRECATED
    ...
    NeovimQt::MsgpackRequest *nvim_buf_get_option(int64_t buffer,
                                                  QByteArray name);
    // void nvim_buf_set_option(Buffer buffer, String name, Object value, )
    NeovimQt::MsgpackRequest *
    nvim_buf_set_option(int64_t buffer, QByteArray name, QVariant value);
    // DEPRECATED
    ...
    NeovimQt::MsgpackRequest *nvim_buf_set_name(int64_t buffer,
                                                QByteArray name);
    ...
    NeovimQt::MsgpackRequest *buffer_insert(int64_t buffer, int64_t lnum,
                                            QList<QByteArray> lines);
    // ArrayOf(Integer, 2) nvim_buf_get_mark(Buffer buffer, String name, )
    NeovimQt::MsgpackRequest *nvim_buf_get_mark(int64_t buffer,
                                                QByteArray name);
    // Integer nvim_buf_add_highlight(Buffer buffer, Integer ns_id, String
    // hl_group, Integer line, Integer col_start, Integer col_end, )
    NeovimQt::MsgpackRequest *
    nvim_buf_add_highlight(int64_t buffer, int64_t ns_id, QByteArray hl_group,
                           int64_t line, int64_t col_start, int64_t col_end);
    // void nvim_buf_clear_namespace(Buffer buffer, Integer ns_id, Integer
    // line_start, Integer line_end, )
    NeovimQt::MsgpackRequest *nvim_buf_clear_namespace(int64_t buffer,
                                                       int64_t ns_id,
                                                       int64_t line_start,
                                                       int64_t line_end);
    // void nvim_buf_clear_highlight(Buffer buffer, Integer ns_id, Integer
    // line_start, Integer line_end, )
    NeovimQt::MsgpackRequest *nvim_buf_clear_highlight(int64_t buffer,
                                                       int64_t ns_id,
                                                       int64_t line_start,
                                                       int64_t line_end);
    // Integer nvim_buf_set_virtual_text(Buffer buffer, Integer ns_id, Integer
    // line, Array chunks, Dictionary opts, )
    NeovimQt::MsgpackRequest *
    nvim_buf_set_virtual_text(int64_t buffer, int64_t ns_id, int64_t line,
                              QVariantList chunks, QVariantMap opts);
    ...
    NeovimQt::MsgpackRequest *nvim_tabpage_get_var(int64_t tabpage,
                                                   QByteArray name);
    // void nvim_tabpage_set_var(Tabpage tabpage, String name, Object value, )
    NeovimQt::MsgpackRequest *
    nvim_tabpage_set_var(int64_t tabpage, QByteArray name, QVariant value);
    // void nvim_tabpage_del_var(Tabpage tabpage, String name, )
    NeovimQt::MsgpackRequest *nvim_tabpage_del_var(int64_t tabpage,
                                                   QByteArray name);
    // DEPRECATED
    // Object tabpage_set_var(Tabpage tabpage, String name, Object value, )
    NeovimQt::MsgpackRequest *tabpage_set_var(int64_t tabpage, QByteArray name,
                                              QVariant value);
    // DEPRECATED
    ...
    NeovimQt::MsgpackRequest *nvim_ui_attach(int64_t width, int64_t height,
                                             QVariantMap options);
    // DEPRECATED
    // void ui_attach(Integer width, Integer height, Boolean enable_rgb, )
    NeovimQt::MsgpackRequest *ui_attach(int64_t width, int64_t height,
                                        bool enable_rgb);
    // void nvim_ui_detach()
    ...
    NeovimQt::MsgpackRequest *nvim_ui_set_option(QByteArray name,
                                                 QVariant value);
    // void nvim_ui_try_resize_grid(Integer grid, Integer width, Integer height,
    // )
    NeovimQt::MsgpackRequest *
    nvim_ui_try_resize_grid(int64_t grid, int64_t width, int64_t height);
    ...
    NeovimQt::MsgpackRequest *nvim_feedkeys(QByteArray keys, QByteArray mode,
                                            bool escape_csi);
    ...
    // Integer grid, Integer row, Integer col, )
    NeovimQt::MsgpackRequest *
    nvim_input_mouse(QByteArray button, QByteArray action, QByteArray modifier,
                     int64_t grid, int64_t row, int64_t col);
    // String nvim_replace_termcodes(String str, Boolean from_part, Boolean
    // do_lt, Boolean special, )
    NeovimQt::MsgpackRequest *nvim_replace_termcodes(QByteArray str,
    ...
    NeovimQt::MsgpackRequest *nvim_execute_lua(QByteArray code,
                                               QVariantList args);
    // Object nvim_call_function(String fn, Array args, )
    NeovimQt::MsgpackRequest *nvim_call_function(QByteArray fn,
                                                 QVariantList args);
    // Object nvim_call_dict_function(Object dict, String fn, Array args, )
    NeovimQt::MsgpackRequest *
    nvim_call_dict_function(QVariant dict, QByteArray fn, QVariantList args);
    ...
    NeovimQt::MsgpackRequest *nvim_open_win(int64_t buffer, bool enter,
                                            QVariantMap config);
    ...
    NeovimQt::MsgpackRequest *nvim_paste(QByteArray data, bool crlf,
                                         int64_t phase);
    // void nvim_put(ArrayOf(String) lines, String type, Boolean after, Boolean
    // follow, )
    NeovimQt::MsgpackRequest *nvim_put(QList<QByteArray> lines, QByteArray type,
    ...
    // void nvim_set_keymap(String mode, String lhs, String rhs, Dictionary
    // opts, )
    NeovimQt::MsgpackRequest *nvim_set_keymap(QByteArray mode, QByteArray lhs,
                                              QByteArray rhs, QVariantMap opts);
    ...
    // void nvim_set_client_info(String name, Dictionary version, String type,
    // Dictionary methods, Dictionary attributes, )
    NeovimQt::MsgpackRequest *
    nvim_set_client_info(QByteArray name, QVariantMap version, QByteArray type,
                         QVariantMap methods, QVariantMap attributes);
    ...
    // Dictionary nvim_parse_expression(String expr, String flags, Boolean
    // highlight, )
    NeovimQt::MsgpackRequest *
    nvim_parse_expression(QByteArray expr, QByteArray flags, bool highlight);
    // Array nvim_list_uis()
    ...
    // void nvim_select_popupmenu_item(Integer item, Boolean insert, Boolean
    // finish, Dictionary opts, )
    NeovimQt::MsgpackRequest *nvim_select_popupmenu_item(int64_t item,
                                                         bool insert,
                                                         bool finish,
                                                         QVariantMap opts);
    ...
    NeovimQt::MsgpackRequest *nvim_win_set_height(int64_t window,
                                                  int64_t height);
    ...
    NeovimQt::MsgpackRequest *nvim_win_set_var(int64_t window, QByteArray name,
                                               QVariant value);
    ...
    NeovimQt::MsgpackRequest *window_set_var(int64_t window, QByteArray name,
                                             QVariant value);
    // DEPRECATED
    ...
    NeovimQt::MsgpackRequest *nvim_win_get_option(int64_t window,
                                                  QByteArray name);
    // void nvim_win_set_option(Window window, String name, Object value, )
    NeovimQt::MsgpackRequest *
    nvim_win_set_option(int64_t window, QByteArray name, QVariant value);
    ...
    NeovimQt::MsgpackRequest *nvim_win_set_config(int64_t window,
                                                  QVariantMap config);
    ...
    // DEPRECATED
    // ArrayOf(String) buffer_get_lines(Buffer buffer, Integer start, Integer
    // end, Boolean strict_indexing, )
    NeovimQt::MsgpackRequest *buffer_get_lines(int64_t buffer, int64_t start,
                                               int64_t end,
                                               bool strict_indexing);
    // DEPRECATED
    // void buffer_set_lines(Buffer buffer, Integer start, Integer end, Boolean
    // strict_indexing, ArrayOf(String) replacement, )
    NeovimQt::MsgpackRequest *buffer_set_lines(int64_t buffer, int64_t start,
                                               int64_t end,
                                               bool strict_indexing,
                                               QList<QByteArray> replacement);
    // DEPRECATED
    ...
    NeovimQt::MsgpackRequest *buffer_get_option(int64_t buffer,
                                                QByteArray name);
    // DEPRECATED
    // void buffer_set_option(Buffer buffer, String name, Object value, )
    NeovimQt::MsgpackRequest *buffer_set_option(int64_t buffer, QByteArray name,
                                                QVariant value);
    // DEPRECATED
    ...
    // DEPRECATED
    // Integer buffer_add_highlight(Buffer buffer, Integer ns_id, String
    // hl_group, Integer line, Integer col_start, Integer col_end, )
    NeovimQt::MsgpackRequest *
    buffer_add_highlight(int64_t buffer, int64_t ns_id, QByteArray hl_group,
                         int64_t line, int64_t col_start, int64_t col_end);
    // DEPRECATED
    // void buffer_clear_highlight(Buffer buffer, Integer ns_id, Integer
    // line_start, Integer line_end, )
    NeovimQt::MsgpackRequest *buffer_clear_highlight(int64_t buffer,
                                                     int64_t ns_id,
                                                     int64_t line_start,
                                                     int64_t line_end);
    // DEPRECATED
    ...
    NeovimQt::MsgpackRequest *vim_feedkeys(QByteArray keys, QByteArray mode,
                                           bool escape_csi);
    // DEPRECATED
    // Integer vim_input(String keys, )
    NeovimQt::MsgpackRequest *vim_input(QByteArray keys);
    // DEPRECATED
    // String vim_replace_termcodes(String str, Boolean from_part, Boolean
    // do_lt, Boolean special, )
    NeovimQt::MsgpackRequest *vim_replace_termcodes(QByteArray str,
                                                    bool from_part, bool do_lt,
                                                    bool special);
    // DEPRECATED
    ...
    NeovimQt::MsgpackRequest *vim_call_function(QByteArray fn,
                                                QVariantList args);
    // DEPRECATED
    ...
    NeovimQt::MsgpackRequest *window_get_option(int64_t window,
                                                QByteArray name);
    // DEPRECATED
    // void window_set_option(Window window, String name, Object value, )
    NeovimQt::MsgpackRequest *window_set_option(int64_t window, QByteArray name,
                                                QVariant value);
    // DEPRECATED
