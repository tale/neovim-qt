...
NeovimApi5::NeovimApi5(NeovimConnector *c) : m_c(c) {
    // EXT types
...
MsgpackRequest *NeovimApi5::nvim_buf_attach(int64_t buffer, bool send_buffer,
                                            QVariantMap opts) {
...
MsgpackRequest *NeovimApi5::buffer_set_line(int64_t buffer, int64_t index,
                                            QByteArray line) {
...
MsgpackRequest *NeovimApi5::buffer_get_line_slice(int64_t buffer, int64_t start,
                                                  int64_t end,
                                                  bool include_start,
                                                  bool include_end) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi5::nvim_buf_get_lines(int64_t buffer, int64_t start,
                                               int64_t end,
...
MsgpackRequest *
NeovimApi5::buffer_set_line_slice(int64_t buffer, int64_t start, int64_t end,
...
MsgpackRequest *NeovimApi5::nvim_buf_set_lines(int64_t buffer, int64_t start,
                                               int64_t end,
                                               bool strict_indexing,
                                               QList<QByteArray> replacement) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi5::nvim_buf_get_keymap(int64_t buffer,
                                                QByteArray mode) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi5::nvim_buf_get_commands(int64_t buffer,
                                                  QVariantMap opts) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi5::nvim_buf_set_var(int64_t buffer, QByteArray name,
                                             QVariant value) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi5::buffer_set_var(int64_t buffer, QByteArray name,
                                           QVariant value) {
...
MsgpackRequest *NeovimApi5::nvim_buf_get_option(int64_t buffer,
                                                QByteArray name) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi5::nvim_buf_set_option(int64_t buffer, QByteArray name,
                                                QVariant value) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi5::buffer_insert(int64_t buffer, int64_t lnum,
...
MsgpackRequest *
NeovimApi5::nvim_buf_add_highlight(int64_t buffer, int64_t ns_id,
...
MsgpackRequest *NeovimApi5::nvim_buf_clear_namespace(int64_t buffer,
                                                     int64_t ns_id,
                                                     int64_t line_start,
                                                     int64_t line_end) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi5::nvim_buf_clear_highlight(int64_t buffer,
                                                     int64_t ns_id,
                                                     int64_t line_start,
                                                     int64_t line_end) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi5::nvim_buf_set_virtual_text(int64_t buffer,
                                                      int64_t ns_id,
                                                      int64_t line,
                                                      QVariantList chunks,
                                                      QVariantMap opts) {
...
MsgpackRequest *NeovimApi5::nvim_tabpage_get_var(int64_t tabpage,
                                                 QByteArray name) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi5::nvim_tabpage_set_var(int64_t tabpage,
                                                 QByteArray name,
                                                 QVariant value) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi5::nvim_tabpage_del_var(int64_t tabpage,
                                                 QByteArray name) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi5::tabpage_set_var(int64_t tabpage, QByteArray name,
                                            QVariant value) {
...
MsgpackRequest *NeovimApi5::nvim_ui_attach(int64_t width, int64_t height,
                                           QVariantMap options) {
...
MsgpackRequest *NeovimApi5::ui_attach(int64_t width, int64_t height,
                                      bool enable_rgb) {
...
MsgpackRequest *NeovimApi5::nvim_ui_set_option(QByteArray name,
                                               QVariant value) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi5::nvim_feedkeys(QByteArray keys, QByteArray mode,
                                          bool escape_csi) {
...
MsgpackRequest *NeovimApi5::nvim_replace_termcodes(QByteArray str,
...
MsgpackRequest *NeovimApi5::nvim_execute_lua(QByteArray code,
                                             QVariantList args) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi5::nvim_call_function(QByteArray fn,
                                               QVariantList args) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi5::nvim_call_dict_function(QVariant dict,
                                                    QByteArray fn,
                                                    QVariantList args) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi5::nvim_set_client_info(QByteArray name,
                                                 QVariantMap version,
                                                 QByteArray type,
                                                 QVariantMap methods,
...
MsgpackRequest *NeovimApi5::nvim_parse_expression(QByteArray expr,
                                                  QByteArray flags,
                                                  bool highlight) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi5::nvim_win_set_height(int64_t window,
                                                int64_t height) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi5::nvim_win_set_var(int64_t window, QByteArray name,
                                             QVariant value) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi5::window_set_var(int64_t window, QByteArray name,
                                           QVariant value) {
...
MsgpackRequest *NeovimApi5::nvim_win_get_option(int64_t window,
                                                QByteArray name) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi5::nvim_win_set_option(int64_t window, QByteArray name,
                                                QVariant value) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi5::buffer_get_lines(int64_t buffer, int64_t start,
                                             int64_t end,
                                             bool strict_indexing) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi5::buffer_set_lines(int64_t buffer, int64_t start,
...
MsgpackRequest *NeovimApi5::buffer_set_option(int64_t buffer, QByteArray name,
                                              QVariant value) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi5::buffer_add_highlight(int64_t buffer, int64_t ns_id,
                                                 QByteArray hl_group,
                                                 int64_t line,
                                                 int64_t col_start,
                                                 int64_t col_end) {
...
MsgpackRequest *NeovimApi5::buffer_clear_highlight(int64_t buffer,
                                                   int64_t ns_id,
                                                   int64_t line_start,
                                                   int64_t line_end) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi5::vim_feedkeys(QByteArray keys, QByteArray mode,
                                         bool escape_csi) {
...
MsgpackRequest *NeovimApi5::vim_replace_termcodes(QByteArray str,
                                                  bool from_part, bool do_lt,
                                                  bool special) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi5::vim_call_function(QByteArray fn,
                                              QVariantList args) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi5::window_set_option(int64_t window, QByteArray name,
                                              QVariant value) {
    MsgpackRequest *r =
...
void NeovimApi5::handleResponseError(quint32 msgid, quint64 fun,
                                     const QVariant &res) {
...
void NeovimApi5::handleResponse(quint32 msgid, quint64 fun,
                                const QVariant &res) {
    switch (fun) {
    case NeovimApi5::NEOVIM_FN_NVIM_BUF_LINE_COUNT: {
        int64_t data;
