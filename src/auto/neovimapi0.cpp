...
NeovimApi0::NeovimApi0(NeovimConnector *c) : m_c(c) {
    // EXT types
...
MsgpackRequest *NeovimApi0::buffer_set_line(int64_t buffer, int64_t index,
                                            QByteArray line) {
...
MsgpackRequest *NeovimApi0::buffer_get_line_slice(int64_t buffer, int64_t start,
                                                  int64_t end,
                                                  bool include_start,
                                                  bool include_end) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi0::buffer_get_lines(int64_t buffer, int64_t start,
                                             int64_t end,
...
MsgpackRequest *
NeovimApi0::buffer_set_line_slice(int64_t buffer, int64_t start, int64_t end,
...
MsgpackRequest *NeovimApi0::buffer_set_lines(int64_t buffer, int64_t start,
...
MsgpackRequest *NeovimApi0::buffer_set_var(int64_t buffer, QByteArray name,
                                           QVariant value) {
...
MsgpackRequest *NeovimApi0::buffer_set_option(int64_t buffer, QByteArray name,
                                              QVariant value) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi0::buffer_insert(int64_t buffer, int64_t lnum,
...
MsgpackRequest *NeovimApi0::buffer_add_highlight(int64_t buffer, int64_t src_id,
                                                 QByteArray hl_group,
                                                 int64_t line,
                                                 int64_t col_start,
                                                 int64_t col_end) {
...
MsgpackRequest *NeovimApi0::buffer_clear_highlight(int64_t buffer,
                                                   int64_t src_id,
                                                   int64_t line_start,
                                                   int64_t line_end) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi0::tabpage_set_var(int64_t tabpage, QByteArray name,
                                            QVariant value) {
...
MsgpackRequest *NeovimApi0::ui_attach(int64_t width, int64_t height,
                                      bool enable_rgb) {
...
MsgpackRequest *NeovimApi0::vim_feedkeys(QByteArray keys, QByteArray mode,
                                         bool escape_csi) {
...
MsgpackRequest *NeovimApi0::vim_replace_termcodes(QByteArray str,
...
MsgpackRequest *NeovimApi0::vim_call_function(QByteArray fname,
                                              QVariantList args) {
    MsgpackRequest *r =
...
MsgpackRequest *NeovimApi0::window_set_var(int64_t window, QByteArray name,
                                           QVariant value) {
...
MsgpackRequest *NeovimApi0::window_set_option(int64_t window, QByteArray name,
                                              QVariant value) {
    MsgpackRequest *r =
...
void NeovimApi0::handleResponseError(quint32 msgid, quint64 fun,
                                     const QVariant &res) {
...
void NeovimApi0::handleResponse(quint32 msgid, quint64 fun,
                                const QVariant &res) {
    switch (fun) {
    case NeovimApi0::NEOVIM_FN_BUFFER_LINE_COUNT: {
        int64_t data;
