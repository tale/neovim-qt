...
class NeovimApi4 : public QObject {
  ...
  public slots:
    ...
    NeovimQt::MsgpackRequest *nvim_buf_get_mark(int64_t buffer,
                                                QByteArray name);
    // Integer nvim_buf_add_highlight(Buffer buffer, Integer src_id, String
    // hl_group, Integer line, Integer col_start, Integer col_end, )
    NeovimQt::MsgpackRequest *
    nvim_buf_add_highlight(int64_t buffer, int64_t src_id, QByteArray hl_group,
                           int64_t line, int64_t col_start, int64_t col_end);
    // void nvim_buf_clear_highlight(Buffer buffer, Integer src_id, Integer
    ...
    // DEPRECATED
    // Integer buffer_add_highlight(Buffer buffer, Integer src_id, String
    // hl_group, Integer line, Integer col_start, Integer col_end, )
    NeovimQt::MsgpackRequest *
    buffer_add_highlight(int64_t buffer, int64_t src_id, QByteArray hl_group,
                         int64_t line, int64_t col_start, int64_t col_end);
    // DEPRECATED
    // void buffer_clear_highlight(Buffer buffer, Integer src_id, Integer
    // line_start, Integer line_end, )
