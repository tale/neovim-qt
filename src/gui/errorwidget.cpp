...
void ErrorWidget::setText(const QString &text) { m_errorLabel->setText(text); }

void ErrorWidget::showReconnect(bool on) { m_closeButton->setVisible(on); }
