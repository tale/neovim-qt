...
class Test : public QObject {
  ...
  private slots:
    ...
    void cellValue() {
        QBENCHMARK {
            Cell c('z', Qt::black, Qt::white, QColor(), false, false, false,
                   false, false, false);
        }
    }
    void cellValueRgb() {
        QBENCHMARK {
            Cell c('z', QRgb(33), QRgb(66), QColor(), false, false, false,
                   false, false, false);
        }
    }
...
void Test::cellOperatorEquals() noexcept {
    const HighlightAttribute hlTextBlackFillWhite{
        Qt::black /*fgColor*/, Qt::white /*bgColor*/,   Qt::red /*spColor*/,
        false /*bold*/,        false /*italic*/,        false /*underline*/,
        false /*undercurl*/,   false /*strikethrough*/, false /*reverse*/};

    const HighlightAttribute hlTextWhiteFillBlack{
        Qt::white /*fgColor*/, Qt::black /*bgColor*/,   Qt::red /*spColor*/,
        false /*bold*/,        false /*italic*/,        false /*underline*/,
        false /*undercurl*/,   false /*strikethrough*/, false /*reverse*/};
    ...
    const HighlightAttribute hlInvTextWhiteFillBlack{
        Qt::white /*fgColor*/, Qt::black /*bgColor*/,   Qt::red /*spColor*/,
        false /*bold*/,        false /*italic*/,        false /*underline*/,
        false /*undercurl*/,   false /*strikethrough*/, true /*reverse*/};

    const HighlightAttribute hlBoldTextWhiteFillBlack{
        Qt::white /*fgColor*/, Qt::black /*bgColor*/,   Qt::red /*spColor*/,
        true /*bold*/,         false /*italic*/,        false /*underline*/,
        false /*undercurl*/,   false /*strikethrough*/, false /*reverse*/};

    bool textDifferent{Cell{' ', hlTextBlackFillWhite} ==
                       Cell{'A', hlTextBlackFillWhite}};
    QVERIFY(textDifferent == false);

    bool textSame{Cell{'B', hlTextBlackFillWhite} ==
                  Cell{'B', hlTextBlackFillWhite}};
    QVERIFY(textSame == true);

    bool colorsDifferent{Cell{' ', hlInvTextWhiteFillBlack} ==
                         Cell{' ', hlTextBlackFillWhite}};
    QVERIFY(colorsDifferent == false);

    // These two styles render identically, but are not equivalent. Their
    // underlying data is different, so they are treated as different.
    bool inverseOpposites{Cell{' ', hlInvTextWhiteFillBlack} ==
                          Cell{' ', hlTextBlackFillWhite}};
    QVERIFY(inverseOpposites == false);

    bool stylesDifferent{Cell{' ', hlBoldTextWhiteFillBlack} ==
                         Cell{' ', hlTextWhiteFillBlack}};
