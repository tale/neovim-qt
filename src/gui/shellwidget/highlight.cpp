...
bool HighlightAttribute::operator==(
    const HighlightAttribute &other) const noexcept {
    return m_foreground == other.m_foreground &&
           m_background == other.m_background && m_special == other.m_special &&
           m_reverse == other.m_reverse && m_italic == other.m_italic &&
           m_bold == other.m_bold && m_underline == other.m_underline &&
