...
class Cell {
  public:
    ...
    Cell(uint character, QColor fgColor, QColor bgColor, QColor spColor,
         bool bold, bool italic, bool underline, bool undercurl,
         bool strikethrough, bool reverse) noexcept
        : Cell{character,
               {fgColor, bgColor, spColor, reverse, italic, bold, underline,
                undercurl, strikethrough}} {}

    /// Create an empty Cell with a background color
    Cell(QColor bgColor) noexcept
        : Cell{' ',
               {QColor::Invalid, bgColor, QColor::Invalid, false, false, false,
                false, false, false}} {}
    ...
    QColor GetForegroundColor() const {
        return m_highlight.GetForegroundColor();
    }

    QColor GetBackgroundColor() const {
        return m_highlight.GetBackgroundColor();
    }
    ...
    /// Checks two cells for style equivalence, ignore differences in
    /// `m_character`
