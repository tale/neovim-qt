...
class HighlightAttribute {
  public:
    HighlightAttribute(QColor foreground, QColor background, QColor special,
                       bool reverse, bool italic, bool bold, bool underline,
                       bool undercurl, bool strikethrough) noexcept
        : m_foreground{foreground},
          m_background{background}, m_special{special}, m_reverse{reverse},
          m_italic{italic}, m_bold{bold}, m_underline{underline},
          m_undercurl{undercurl}, m_strikethrough{strikethrough} {}
