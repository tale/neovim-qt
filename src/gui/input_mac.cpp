...
Qt::KeyboardModifiers ControlModifier() noexcept { return Qt::MetaModifier; }

Qt::KeyboardModifiers CmdModifier() noexcept { return Qt::ControlModifier; }

Qt::Key Key_Control() noexcept { return Qt::Key_Meta; }

Qt::Key Key_Cmd() noexcept { return Qt::Key_Control; }
...
// Other keyboard locales do not require Alt (US "{"). Remove Alt on layouts
// where the key modifies text input. Qt does not provide a robust
// layout-detection mechanism. Instead, measure Qt::Key and text mis-match with
// Alt present.
//
// See Pull Requests 837 and 841 for more details.
static bool IsAsciiCharRequiringAlt(int key, Qt::KeyboardModifiers mod,
                                    QChar c) noexcept {
